...
- TypeScript 5.9 (strict mode) + Pure engine logic — no React, no Expo, no new packages (009-hand-sort-enhancements)
...
## Recent Changes
- 009-hand-sort-enhancements: Added TypeScript 5.9 (strict mode) + Pure engine logic — no React, no Expo, no new packages
